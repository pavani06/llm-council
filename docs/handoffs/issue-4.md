# Handoff — issue #4 (T2)
PR #19 · branch issue/4-config-perfis (código em d0ab7ec1dcd0) · 2026-08-25
...
- `test_offline.py`: seção 16 (23 checks: válido, defaults de tabela vazia, 15 inválidos nomeados — incluindo tipos errados em roles/criteria e containers malformados/falsy — e council.toml real sem perfis).
