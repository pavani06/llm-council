...
- `test_offline.py`: seção 16 (23 checks: válido, defaults de tabela vazia, 18 inválidos nomeados — incluindo tipos errados em roles/criteria e containers malformados/falsy — e council.toml real sem perfis).
