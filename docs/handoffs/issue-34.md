# Handoff — issue #34 (C5)
PR #40 · branch issue/34-cost-ledger (código em 2ef7e2d86504) · 2026-08-26
...
- `test_offline.py`: seção 29, 14 checks — ledger contra soma manual (final+parcial+antigo), estimativa com histórico (aritmética da config, medianas identificadas, cota glm=2), N=2 pula estágio 2, perfil inexistente exit 2, sem histórico exit 3. Suite 389 checks exit 0; golden (seção 15) byte a byte.
