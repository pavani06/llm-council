...
- `test_offline.py`: seção 24 (15 checks: os anteriores + drift da descricao do debate, run_refs string/vazio recusados, members sem casamento, pergunta vazia, candidates sem texto).
